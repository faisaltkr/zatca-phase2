...
def item_data(invoice,p_invoice_doc):
            try:    
                for single_item in p_invoice_doc.items : 
                    ...
                    cbc_LineExtensionAmount_1.set("currencyID", p_invoice_doc.currency)
                    ...
                    cbc_TaxAmount_3.set("currencyID", p_invoice_doc.currency)
                    ...
                    cbc_RoundingAmount.set("currencyID", p_invoice_doc.currency)
                    ...
                    cbc_PriceAmount.set("currencyID", p_invoice_doc.currency)
