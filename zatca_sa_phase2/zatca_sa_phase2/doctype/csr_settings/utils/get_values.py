...
def get_zatca_settings():
    doc = frappe.get_all('CSR Settings',fields = ['company_name','street','building_number','city','district','postal_code','vat_registration_number','issuer_name','issuer_serial_number','additional_id','value_number'])
    return doc[0]
